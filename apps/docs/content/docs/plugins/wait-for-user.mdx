...
If you want the handoff panel to stay near the cursor with Floating UI collision handling, use `FloatingWaitForUserPlugin` or `createFloatingWaitForUserPositioner()`.
