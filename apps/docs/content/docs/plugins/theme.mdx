...
<iframe src="/demos/theme" className="w-full h-80 rounded-xl border mt-6 overflow-hidden relative" />

### Options

| Option | Type      | Default | Description                                  |
|--------|-----------|---------|----------------------------------------------|
| `auto` | `boolean` | `true`  | Automatically infer cursor shape via elements. |
