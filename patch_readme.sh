...
/## Plugins/ {
    ...
    print "- **TrailPlugin** <span title=\"Pro\" style=\"cursor: help;\">💎</span>: Adds a magical trail effect to the cursor (Pro)."
    print "- **GeminiTTSPlugin** <span title=\"Pro\" style=\"cursor: help;\">💎</span>: High-quality text-to-speech using Google Gemini (Pro).\n"
    next
}
