...
import { Cursor, ClickSoundPlugin, LoggingPlugin } from '@cursor.js/core';
...
export function ClientPage() {
  ...
  useEffect(() => {
    ...
    cursor.use(new ClickSoundPlugin({ volume: 0.5, soundUrl: '/click.mp3' }));
    // Wait until user interacts before playing sound to bypass modern browser autoplay policies
