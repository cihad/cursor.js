...
If you want the handoff panel to stay near the cursor with Floating UI collision handling, install `FloatingPlugin` or pass `createFloatingWaitForUserPositioner()` manually.
